"""Problem specification definitions."""

import logging
from collections.abc import Callable
from dataclasses import dataclass, field
from typing import Annotated, Any, Dict, List, Literal, Tuple, Union, Optional
...
class ProblemSpec:
    ...
    demo: bool = False
    too_hard: bool = False
    debug_report_path: str = "/home/ubuntu/example-verilog-codebase/DEBUG_REPORT.md"
