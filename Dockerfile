...
# configure git
RUN git config --global user.email "992571389@qq.com"
RUN git config --global user.name "Charlie-ZHIJIE"
...
ARG TEST_BRANCH=skid_buffer_test
ARG GOLDEN_BRANCH=skid_buffer_golden
ARG BASELINE_BRANCH=skid_buffer_baseline
