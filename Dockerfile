...
ARG TEST_BRANCH=mac_rx_test
ARG GOLDEN_BRANCH=mac_rx_golden
ARG BASELINE_BRANCH=mac_rx_baseline

# Generate patches for grading BEFORE removing git history
...
# Checkout baseline branch for the agent to work on
